    ...
    namespace Math {
        ...
        class Matrix2d {
         public:
            ...
            [[nodiscard]] auto begin() const -> typename std::vector<T>::const_iterator { return m_values.begin(); }
            [[nodiscard]] auto end() const -> typename std::vector<T>::const_iterator { return m_values.end(); }
