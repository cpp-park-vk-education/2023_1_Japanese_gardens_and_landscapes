...
namespace AnimeDefendersEngine::Physics {
    ...
    struct BodyDefinition {
        ...
        BodyDefinition(const std::string& id, std::unique_ptr<Shape> shape, BodyType bodyType, Transform transform, Math::Vector2f velocity,
                       float mass, std::size_t layers, Math::Vector2f force, bool isTrigger);
